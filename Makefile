...
DIST          = /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		PrimeNumberGame.pro src/CrashResult.cpp \
		src/Field.cpp \
		src/main.cpp \
		src/Sight.cpp \
		src/event/CrashEvent.cpp \
