...
# Template: app
# Command: /opt/Qt/5.3/gcc_64/bin/qmake -o Makefile PeculiarEngine.pro
#############################################################################
...
DIST          = /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		PeculiarEngine.pro src/CrashResult.cpp \
		src/Field.cpp \
		src/main.cpp \
		src/Sight.cpp \
		src/event/CrashEvent.cpp \
...
Makefile: PeculiarEngine.pro /opt/Qt/5.3/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d generated/PeculiarEngine1.0.0 || mkdir -p generated/PeculiarEngine1.0.0
	$(COPY_FILE) --parents $(DIST) generated/PeculiarEngine1.0.0/ && $(COPY_FILE) --parents src/CrashResult.h src/Field.h src/Sight.h src/event/CrashEvent.h src/event/Event.h src/event/ForceEvent.h src/event/MoveEvent.h src/force/Force.h src/force/Gravity.h src/force/Impulse.h src/force/UniversalForce.h src/force/UniversalTorque.h src/object/Gunner.h src/object/NumberBox.h src/object/Object.h src/object/ObjectStatus.h src/object/Player.h src/object/PlayerNeo.h src/util/Array.h src/util/Calculater.h src/util/Define.h src/util/Pair.h src/util/Vector.h generated/PeculiarEngine1.0.0/ && $(COPY_FILE) --parents src/CrashResult.cpp src/Field.cpp src/main.cpp src/Sight.cpp src/event/CrashEvent.cpp src/event/Event.cpp src/event/ForceEvent.cpp src/event/MoveEvent.cpp src/force/Force.cpp src/force/Gravity.cpp src/force/Impulse.cpp src/force/UniversalForce.cpp src/force/UniversalTorque.cpp src/object/Gunner.cpp src/object/NumberBox.cpp src/object/Object.cpp src/object/ObjectStatus.cpp src/object/Player.cpp src/object/PlayerNeo.cpp src/util/Calculater.cpp src/util/Vector.cpp generated/PeculiarEngine1.0.0/ && (cd `dirname generated/PeculiarEngine1.0.0` && $(TAR) PeculiarEngine1.0.0.tar PeculiarEngine1.0.0 && $(COMPRESS) PeculiarEngine1.0.0.tar) && $(MOVE) `dirname generated/PeculiarEngine1.0.0`/PeculiarEngine1.0.0.tar.gz . && $(DEL_FILE) -r generated/PeculiarEngine1.0.0
...
generated/moc_Field.cpp: /opt/Qt/5.3/gcc_64/include/QtCore/QObject \
		...
		src/util/Define.h \
		src/Field.h
	/opt/Qt/5.3/gcc_64/bin/moc $(DEFINES) -I/opt/Qt/5.3/gcc_64/mkspecs/linux-g++ -I/home/sanada/git/sana37/PeculiarEngine -I/home/sanada/git/sana37/PeculiarEngine -I/home/sanada/git/sana37/PeculiarEngine/src -I/home/sanada/git/sana37/PeculiarEngine/src/util -I/home/sanada/git/sana37/PeculiarEngine/src/object -I/home/sanada/git/sana37/PeculiarEngine/src/event -I/home/sanada/git/sana37/PeculiarEngine/src/force -I/opt/Qt/5.3/gcc_64/include -I/opt/Qt/5.3/gcc_64/include/QtOpenGL -I/opt/Qt/5.3/gcc_64/include/QtWidgets -I/opt/Qt/5.3/gcc_64/include/QtGui -I/opt/Qt/5.3/gcc_64/include/QtCore src/Field.h -o generated/moc_Field.cpp
