...
void Field::CrashEvent::reflect(short formerNum , short latterNum)
{
	...
	switch(field->stateCrash[formerNum][latterNum]){
		case 'A' : {
			(field->object[formerNum]->getPolygon2Vertex(field->indexCrash[formerNum][latterNum]) - field->object[formerNum]->getPolygon1Vertex(field->indexCrash[formerNum][latterNum])).getVector(P);
			(field->object[formerNum]->getPolygon3Vertex(field->indexCrash[formerNum][latterNum]) - field->object[formerNum]->getPolygon1Vertex(field->indexCrash[formerNum][latterNum])).getVector(Q);

			break;
		}
		case 'B' : {
			(field->object[latterNum]->getPolygon2Vertex(field->indexCrash[latterNum][formerNum]) - field->object[latterNum]->getPolygon1Vertex(field->indexCrash[latterNum][formerNum])).getVector(P);
			(field->object[latterNum]->getPolygon3Vertex(field->indexCrash[latterNum][formerNum]) - field->object[latterNum]->getPolygon1Vertex(field->indexCrash[latterNum][formerNum])).getVector(Q);

			break;
		}
		case 'C' : {
			(field->object[formerNum]->getLineLVertex(field->indexCrash[formerNum][latterNum]) - field->object[formerNum]->getLineRVertex(field->indexCrash[formerNum][latterNum])).getVector(P);
			(field->object[latterNum]->getLineLVertex(field->indexCrash[latterNum][formerNum]) - field->object[latterNum]->getLineRVertex(field->indexCrash[latterNum][formerNum])).getVector(Q);
...
bool Field::CrashEvent::cubicEquation(float* a , float* b , float* c , float* k , float* ans)
{
